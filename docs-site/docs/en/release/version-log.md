...
- Release commit / 发布提交: `46acfb2d2`
- Commit date / 提交日期: 2026-07-12
- Commit subject / 提交说明: Release v1.4.1: 生产就绪校验对支付渠道 apiurl 无法验证降级为告警(不阻断发布)
