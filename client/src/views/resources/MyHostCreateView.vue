            ...
            <div class="modal-body space-y-4">
              ...
              <div class="space-y-2">
                <div class="flex items-center gap-2">
                  <span class="flex items-center justify-center w-6 h-6 rounded-full text-xs font-medium" :class="installStatus === 'success' ? 'bg-green-500 text-white' : 'bg-accent text-white dark:text-black'">1</span>
